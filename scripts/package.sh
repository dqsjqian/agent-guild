...
for d in ONBOARDING CONVENTIONS SPEC LEARNINGS PORTABILITY README README_EN; do
...
import re, sys
p = sys.argv[1]
names = "ONBOARDING|CONVENTIONS|SPEC|LEARNINGS|PORTABILITY|README_EN|README"
